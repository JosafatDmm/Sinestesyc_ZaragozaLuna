...
class Formadimencional {
  String nombre;
  int hp;
  int ataque;
  int tipo;
  int seleccionado;
  Formadimencional(String nombre_, int hp_, int ataque_, int tipo_) {
    nombre =nombre_;
    hp = hp_;
    ataque = ataque_;
    tipo = tipo_;
...
Formadimencional fd1;
Formadimencional fd2;
Formadimencional fd3;
Formadimencional fd4;
Formadimencional fd5;

Formadimencional fd1b;
Formadimencional fd2b;
Formadimencional fd3b;
Formadimencional fd4b;
Formadimencional fd5b;
...
void setup() {
  ...
  background(#FFE8B6);
//Para el jugador 1:
  fd1 = new Formadimencional("Wakz", 20, 1, 0);
  fd2 = new Formadimencional("Vazz", 20, 1, 1);
  fd3 = new Formadimencional("Kandy", 20, 1, 2);
  fd4 = new Formadimencional("Zky", 20, 1, 3);
  fd5 = new Formadimencional("Ulu", 20, 1, 4);
//Para el jugador 1: 
  fd1b = new Formadimencional("Wakz", 20, 1, 0);
  fd2b = new Formadimencional("Vazz", 20, 1, 1);
  fd3b = new Formadimencional("Kandy", 20, 1, 2);
  fd4b = new Formadimencional("Zky", 20, 1, 3);
  fd5b = new Formadimencional("Ulu", 20, 1, 4);
}
void draw() {
  switch(screen) {
  case 0:
...
text("En una dimensión muy parecida a la Sinestesia, diferentes formas se debaten su pase a esta dimensión",550,200);
textSize(22);
textAlign(CENTER,CENTER);
text("El ganador podrá llegar al mundo físico en forma de Arte, elijan su avatar y a jugar",550,400);
  pushMatrix();
  textSize(42);
  textAlign(CENTER,CENTER);
  fill(random(0, 100));
  text("Presiona la pantalla para comenzar", 870, 550);
  popMatrix();
  if (mousePressed) {
    screen = 2;
  }
...
//jugador 1:
  ...
  fill(#F52419);
  stroke(0);
  String s3 = "Jugador uno golpea con X";
...
void fin() {
  ...
  fill(#FA6A6A);
  stroke(0);
  String s3 = "Toca la pantalla para iniciar una nueva batalla";
